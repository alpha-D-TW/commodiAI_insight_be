...
class S3PdfFileLoader(UnstructuredBaseLoader):
    ...
    def _get_elements(self) -> List:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            return partition(filename=file_path, include_page_breaks=True, content_type="application/pdf")
